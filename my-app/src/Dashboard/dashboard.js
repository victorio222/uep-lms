          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-6">
            {filteredSubjects.length > 0 ? (
              filteredSubjects.map((subject) => (
                <div
                  key={subject.courseId}
                  className={`group relative bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl hover:scale-110 hover:rotate-3 transition-all duration-500 ease-in-out transform hover:translate-y-3 ${subject.status === "unpublished" ? "opacity-50 grayscale" : ""
                    }`}
                >
                  <div
                    className={`h-32 flex items-center justify-center ${subject.status === "unpublished" ? "saturate-50" : ""
                      }`}
                    style={{ backgroundColor: subject.color }}
                  >
                    <div className="circle group-hover:scale-150 group-hover:rotate-180 group-hover:bg-blue-500 transition-all duration-500 ease-in-out">
                  ...
                  <div className="p-4 group-hover:bg-gray-50 group-hover:shadow-2xl transition-all duration-300 ease-in-out">
                    ...
                    <button
                      onClick={() => handleChangeStatus(subject.courseId)}
                      className={`w-full py-2 px-4 rounded-md text-sm font-medium transition-all duration-300 ${subject.status === "active"
                          ? "bg-green-500 hover:bg-green-600 text-white hover:shadow-md"
                          : subject.status === "unpublished"
                            ? "bg-gray-400 text-gray-600 hover:bg-gray-500 hover:shadow-md"
                            : "bg-red-500 hover:bg-red-600 text-white hover:shadow-md"
